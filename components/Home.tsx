...
function HomeComponent() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setHighlightedIndex((prevIndex) => (prevIndex + 1) % headings.length);
    }, 1000);
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setHighlightedIndex2((prevIndex) => (prevIndex + 1) % headings2.length);
    }, 1000);
    return () => clearInterval(interval);
  }, [headings2.length]);
      ...
      <nav className="nav">
        <div className="nav__wrapper">
          <figure className="nav__img--mask">
            <Image className="nav__img" src="/assets/logo.png" alt="logo" width={200} height={40} />
          </figure>
                ...
                {headings.map((heading, index) => (
                  <div
                    ...
                    className={`statistics__heading ${
                      index === highlightedIndex ? "statistics__heading--active" : ""
                    }`}
                  >
                    {heading}
                  </div>
              ...
              >
                {headings2.map((heading, index) => (
                  <div
                    key={index}
                    className={`statistics__heading ${
                      index === highlightedIndex2 ? "statistics__heading--active" : ""
                    }`}
                  >
                    {heading}
                  </div>
